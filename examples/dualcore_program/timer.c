...
static timer_callback_t timer0_callback_0 = 0;
static timer_callback_t timer0_callback_1 = 0;
...
void timer0_set_callback_0(timer_callback_t callback) {
    timer0_callback_0 = callback;
}
void timer0_set_callback_1(timer_callback_t callback) {
    timer0_callback_1 = callback;
}
...
void TIMER0_Handler_0(void) {
    ...
    // Call user callback if registered
    if (timer0_callback_0 != 0) {
        timer0_callback_0();
    }
}
void TIMER0_Handler_1(void) {
    // Clear interrupt flag
    TIMER0->INTCLEAR = ( 1ul <<  0 );
