Creating summary for main/32:


Creating summary for PIT0_Handler/31:


Creating summary for timerDisable/30:


Creating summary for timerSetUp/29:


Creating summary for task2/28:
  Descriptor for parameter 0 p2D.7107
    (locally) unused
    not a candidate for splitting


Creating summary for task1/27:
  Descriptor for parameter 0 p2D.7103
    (locally) unused
    not a candidate for splitting


Creating summary for task0/26:
  Descriptor for parameter 0 p1D.7099
    (locally) unused
    not a candidate for splitting


Creating summary for vApplicationMallocFailedHook/22:


Creating summary for vApplicationStackOverflowHook/21:
  Descriptor for parameter 0 pxTaskD.7089
    unused with 0 call_uses
    not a candidate
  Descriptor for parameter 1 pcTaskNameD.7090
    unused with 0 call_uses
...
Creating summary for vAssertCalled/20:
  Descriptor for parameter 0 ulLineD.7085
    unused with 0 call_uses
    not a candidate
  Descriptor for parameter 1 pcFileD.7086
    unused with 0 call_uses
    by_ref with 0 pass throughs
----------------------------------------
  Descriptor for parameter 0 ulLineD.7085
...
Creating summary for vApplicationTickHook/19:



========== IPA-SRA IPA stage ==========

Summary for node main/32:
  Returns value
  No parameter information. 

  Summary for edge main/32->vTaskStartScheduler/38:
    return value ignored
  Summary for edge main/32->xTaskCreate/37:
  Summary for edge main/32->xTaskCreate/37:
  Summary for edge main/32->xTaskCreate/37:
  Summary for edge main/32->xQueueGenericCreate/36:
  Summary for edge main/32->xQueueGenericCreate/36:
  Summary for edge main/32->xQueueGenericCreate/36:

Summary for node PIT0_Handler/31:
  No parameter information. 


Summary for node timerDisable/30:
  No parameter information. 


Summary for node timerSetUp/29:
  No parameter information. 

  Summary for edge timerSetUp/29->vInitInterruptTable/35:
    return value ignored

Summary for node task2/28:
  Descriptor for parameter 0:
    (locally) unused
    not a candidate for splitting

  Summary for edge task2/28->xQueueGenericSend/34:
    return value ignored
  Summary for edge task2/28->xQueueSemaphoreTake/33:
  Summary for edge task2/28->timerSetUp/29:
    return value ignored

Summary for node task1/27:
  Descriptor for parameter 0:
    (locally) unused
    not a candidate for splitting

  Summary for edge task1/27->xQueueGenericSend/34:
    return value ignored
  Summary for edge task1/27->xQueueSemaphoreTake/33:

Summary for node task0/26:
  Descriptor for parameter 0:
    (locally) unused
    not a candidate for splitting

  Summary for edge task0/26->xQueueSemaphoreTake/33:

Summary for node vApplicationMallocFailedHook/22:
  No parameter information. 


Summary for node vApplicationStackOverflowHook/21:
  Descriptor for parameter 0:
    (locally) unused
    not a candidate for splitting
...
Summary for node vAssertCalled/20:
  Descriptor for parameter 0:
    (locally) unused
    not a candidate for splitting
  Descriptor for parameter 1:
...
Summary for node vApplicationTickHook/19:
  No parameter information. 



Function vApplicationTickHook/19 disqualified because it cannot be made local.
Function vAssertCalled/20 disqualified because it cannot be made local.
Function vApplicationStackOverflowHook/21 disqualified because it cannot be made local.
Function vApplicationMallocFailedHook/22 disqualified because it cannot be made local.
Function task0/26 disqualified because it cannot be made local.
Function task1/27 disqualified because it cannot be made local.
Function timerSetUp/29 disqualified because it cannot be made local.
Function task2/28 disqualified because it cannot be made local.
Function timerDisable/30 disqualified because it cannot be made local.
Function PIT0_Handler/31 disqualified because it cannot be made local.
Function main/32 disqualified because it cannot be made local.
