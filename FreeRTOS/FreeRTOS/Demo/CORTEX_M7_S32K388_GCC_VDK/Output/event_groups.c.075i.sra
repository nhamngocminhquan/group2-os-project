Creating summary for xEventGroupSetBits.part.0/31:
  Descriptor for parameter 0 xEventGroupD.6737
    not a candidate for splitting
  Descriptor for parameter 1 uxBitsToSetD.6738
    not a candidate for splitting


Creating summary for xEventGroupClearBits.part.0/30:
  Descriptor for parameter 0 xEventGroupD.6721
    not a candidate for splitting
  Descriptor for parameter 1 uxBitsToClearD.6722
    not a candidate for splitting


Creating summary for vEventGroupSetNumber/17:
  Descriptor for parameter 0 xEventGroupD.6556
    not a candidate for splitting
  Descriptor for parameter 1 uxEventGroupNumberD.6557
    not a candidate for splitting


Creating summary for uxEventGroupGetNumber/16:
  Descriptor for parameter 0 xEventGroupD.6551
    not a candidate for splitting


Creating summary for xEventGroupSetBitsFromISR/15:
  Descriptor for parameter 0 xEventGroupD.6545
    unused with 1 call_uses
    by_ref with 1 pass throughs
  Descriptor for parameter 1 uxBitsToSetD.6546
    unused with 1 call_uses
    not a candidate
  Descriptor for parameter 2 pxHigherPriorityTaskWokenD.6547
    unused with 1 call_uses
    by_ref with 1 pass throughs
----------------------------------------
  Descriptor for parameter 0 xEventGroupD.6545
...
Creating summary for prvTestWaitCondition/14:
  Descriptor for parameter 0 uxCurrentEventBitsD.6539
    not a candidate for splitting
  Descriptor for parameter 1 uxBitsToWaitForD.6540
    not a candidate for splitting
  Descriptor for parameter 2 xWaitForAllBitsD.6541
    not a candidate for splitting


Creating summary for vEventGroupClearBitsCallback/13:
  Descriptor for parameter 0 pvEventGroupD.6535
    (locally) unused
    not a candidate for splitting
  Descriptor for parameter 1 ulBitsToClearD.6536
    (locally) unused
    not a candidate for splitting


Creating summary for vEventGroupSetBitsCallback/12:
  Descriptor for parameter 0 pvEventGroupD.6531
    (locally) unused
    not a candidate for splitting
  Descriptor for parameter 1 ulBitsToSetD.6532
    (locally) unused
    not a candidate for splitting


Creating summary for vEventGroupDelete/11:
  Descriptor for parameter 0 xEventGroupD.6521
    not a candidate for splitting


Creating summary for xEventGroupSetBits/10:
  Descriptor for parameter 0 xEventGroupD.6503
    not a candidate for splitting
  Descriptor for parameter 1 uxBitsToSetD.6504
    not a candidate for splitting


Creating summary for xEventGroupGetBitsFromISR/9:
  Descriptor for parameter 0 xEventGroupD.6497
    not a candidate
----------------------------------------
  Descriptor for parameter 0 xEventGroupD.6497
    not a candidate for splitting
...
Creating summary for xEventGroupClearBitsFromISR/8:
  Descriptor for parameter 0 xEventGroupD.6492
    unused with 1 call_uses
    by_ref with 1 pass throughs
  Descriptor for parameter 1 uxBitsToClearD.6493
    unused with 1 call_uses
    not a candidate
----------------------------------------
  Descriptor for parameter 0 xEventGroupD.6492
...
Creating summary for xEventGroupClearBits/7:
  Descriptor for parameter 0 xEventGroupD.6484
    not a candidate for splitting
  Descriptor for parameter 1 uxBitsToClearD.6485
    not a candidate for splitting


Creating summary for xEventGroupWaitBits/6:
  Descriptor for parameter 0 xEventGroupD.6466
    not a candidate for splitting
  Descriptor for parameter 1 uxBitsToWaitForD.6467
    not a candidate for splitting
  Descriptor for parameter 2 xClearOnExitD.6468
    not a candidate for splitting
  Descriptor for parameter 3 xWaitForAllBitsD.6469
    not a candidate for splitting
  Descriptor for parameter 4 xTicksToWaitD.6470
    not a candidate for splitting


Creating summary for xEventGroupSync/5:
  Descriptor for parameter 0 xEventGroupD.6452
    not a candidate for splitting
  Descriptor for parameter 1 uxBitsToSetD.6453
    not a candidate for splitting
  Descriptor for parameter 2 uxBitsToWaitForD.6454
    not a candidate for splitting
  Descriptor for parameter 3 xTicksToWaitD.6455
    not a candidate for splitting


Creating summary for xEventGroupCreate/4:



========== IPA-SRA IPA stage ==========

Summary for node xEventGroupSetBits.part.0/31:
  Returns value
  ...
  Summary for edge xEventGroupSetBits.part.0/31->vTaskSuspendAll/21:
    return value ignored
  Summary for edge xEventGroupSetBits.part.0/31->vTaskRemoveFromUnorderedEventList/28:
    return value ignored
  Summary for edge xEventGroupSetBits.part.0/31->xTaskResumeAll/23:
    return value ignored

Summary for node xEventGroupClearBits.part.0/30:
  Returns value
  Descriptor for parameter 0:
    not a candidate for splitting
  Descriptor for parameter 1:
  ...
  Summary for edge xEventGroupClearBits.part.0/30->vPortEnterCritical/25:
    return value ignored
  Summary for edge xEventGroupClearBits.part.0/30->vPortExitCritical/26:
    return value ignored

Summary for node vEventGroupSetNumber/17:
  Descriptor for parameter 0:
    not a candidate for splitting
  Descriptor for parameter 1:
    not a candidate for splitting
...
Summary for node uxEventGroupGetNumber/16:
  Returns value
  Descriptor for parameter 0:
    not a candidate for splitting


Summary for node xEventGroupSetBitsFromISR/15:
  Returns value
  Descriptor for parameter 0:
    (locally) unused
    param_size_limit: 4, size_reached: 0, by_ref
  ...
  Summary for edge xEventGroupSetBitsFromISR/15->xTimerPendFunctionCallFromISR/27:
...
Summary for node prvTestWaitCondition/14:
  Returns value
  Descriptor for parameter 0:
    not a candidate for splitting
  Descriptor for parameter 1:
...
Summary for node vEventGroupClearBitsCallback/13:
  Descriptor for parameter 0:
    (locally) unused
    not a candidate for splitting
  Descriptor for parameter 1:
  ...
  Summary for edge vEventGroupClearBitsCallback/13->xEventGroupClearBits/7:
    return value ignored
    Parameter 0:
      Scalar param sources: 0
...
Summary for node vEventGroupSetBitsCallback/12:
  Descriptor for parameter 0:
    (locally) unused
    not a candidate for splitting
  Descriptor for parameter 1:
  ...
  Summary for edge vEventGroupSetBitsCallback/12->xEventGroupSetBits/10:
    return value ignored
    Parameter 0:
      Scalar param sources: 0
      Pointer pass through from the param given above, safe_to_import_accesses: 0
...
Summary for node vEventGroupDelete/11:
  Descriptor for parameter 0:
    not a candidate for splitting

  Summary for edge vEventGroupDelete/11->vPortFree/29:
    return value ignored
  Summary for edge vEventGroupDelete/11->xTaskResumeAll/23:
    return value ignored
  Summary for edge vEventGroupDelete/11->vTaskRemoveFromUnorderedEventList/28:
    return value ignored
  Summary for edge vEventGroupDelete/11->vTaskSuspendAll/21:
    return value ignored

Summary for node xEventGroupSetBits/10:
  Returns value
  Descriptor for parameter 0:
    not a candidate for splitting
  Descriptor for parameter 1:
  ...
  Summary for edge xEventGroupSetBits/10->xEventGroupSetBits.part.0/31:
    return value used only to compute caller return value
    Parameter 0:
      Scalar param sources: 0
      Pointer pass through from the param given above, safe_to_import_accesses: 0
...
Summary for node xEventGroupGetBitsFromISR/9:
  Returns value
  Descriptor for parameter 0:
    not a candidate for splitting


Summary for node xEventGroupClearBitsFromISR/8:
  Returns value
  Descriptor for parameter 0:
    (locally) unused
    param_size_limit: 4, size_reached: 0, by_ref
  ...
  Summary for edge xEventGroupClearBitsFromISR/8->xTimerPendFunctionCallFromISR/27:
    return value used only to compute caller return value
    Parameter 0:
    Parameter 1:
      Scalar param sources: 0
...
Summary for node xEventGroupClearBits/7:
  Returns value
  Descriptor for parameter 0:
    not a candidate for splitting
  Descriptor for parameter 1:
  ...
  Summary for edge xEventGroupClearBits/7->xEventGroupClearBits.part.0/30:
    return value used only to compute caller return value
    Parameter 0:
      Scalar param sources: 0
      Pointer pass through from the param given above, safe_to_import_accesses: 0
...
Summary for node xEventGroupWaitBits/6:
  Returns value
  Descriptor for parameter 0:
    not a candidate for splitting
  Descriptor for parameter 1:
  ...
  Summary for edge xEventGroupWaitBits/6->vPortExitCritical/26:
    return value ignored
  Summary for edge xEventGroupWaitBits/6->prvTestWaitCondition/14:
    Parameter 0:
    Parameter 1:
      Scalar param sources: 1
    Parameter 2:
      Scalar param sources: 3
  Summary for edge xEventGroupWaitBits/6->vPortEnterCritical/25:
    return value ignored
  Summary for edge xEventGroupWaitBits/6->uxTaskResetEventItemValue/24:
  Summary for edge xEventGroupWaitBits/6->xTaskResumeAll/23:
  Summary for edge xEventGroupWaitBits/6->vTaskPlaceOnUnorderedEventList/22:
    return value ignored
    Parameter 0:
    Parameter 1:
      Scalar param sources: 1
  ...
  Summary for edge xEventGroupWaitBits/6->prvTestWaitCondition/14:
    ...
    Parameter 2:
      Scalar param sources: 3
  Summary for edge xEventGroupWaitBits/6->vTaskSuspendAll/21:
    return value ignored
  Summary for edge xEventGroupWaitBits/6->xTaskGetSchedulerState/20:

Summary for node xEventGroupSync/5:
  Returns value
  Descriptor for parameter 0:
    not a candidate for splitting
  Descriptor for parameter 1:
  ...
  Summary for edge xEventGroupSync/5->vPortExitCritical/26:
    return value ignored
  Summary for edge xEventGroupSync/5->vPortEnterCritical/25:
    return value ignored
  Summary for edge xEventGroupSync/5->uxTaskResetEventItemValue/24:
  Summary for edge xEventGroupSync/5->xTaskResumeAll/23:
  Summary for edge xEventGroupSync/5->vTaskPlaceOnUnorderedEventList/22:
    return value ignored
  Summary for edge xEventGroupSync/5->xEventGroupSetBits/10:
    return value ignored
  Summary for edge xEventGroupSync/5->vTaskSuspendAll/21:
    return value ignored
  Summary for edge xEventGroupSync/5->xTaskGetSchedulerState/20:

Summary for node xEventGroupCreate/4:
  Returns value
  No parameter information. 

  Summary for edge xEventGroupCreate/4->vListInitialise/19:
    return value ignored
  Summary for edge xEventGroupCreate/4->pvPortMalloc/18:


Function xEventGroupCreate/4 disqualified because it cannot be made local.
Function xEventGroupSetBits/10 disqualified because it cannot be made local.
Function xEventGroupSync/5 disqualified because it cannot be made local.
Function xEventGroupWaitBits/6 disqualified because it cannot be made local.
Function xEventGroupClearBits/7 disqualified because it cannot be made local.
Function xEventGroupClearBitsFromISR/8 disqualified because it cannot be made local.
Function xEventGroupGetBitsFromISR/9 disqualified because it cannot be made local.
Function vEventGroupDelete/11 disqualified because it cannot be made local.
Function vEventGroupSetBitsCallback/12 disqualified because it cannot be made local.
Function vEventGroupClearBitsCallback/13 disqualified because it cannot be made local.
Function xEventGroupSetBitsFromISR/15 disqualified because it cannot be made local.
Function uxEventGroupGetNumber/16 disqualified because it cannot be made local.
Function vEventGroupSetNumber/17 disqualified because it cannot be made local.
