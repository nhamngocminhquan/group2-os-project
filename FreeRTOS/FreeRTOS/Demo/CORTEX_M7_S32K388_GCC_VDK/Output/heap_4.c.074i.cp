...
Determining dynamic type for call: prvInsertBlockIntoFreeList (puc_13);
  Starting walk at: prvInsertBlockIntoFreeList (puc_13);
  instance pointer: puc_13  Outer instance pointer: puc_13 offset: 0 (bits) vtbl reference: 
  Function call may change dynamic type:vTaskSuspendAll ();

IPA structures before propagation:

Jump functions:
  Jump functions of caller  vPortExitCritical/27:
  Jump functions of caller  vPortEnterCritical/26:
  Jump functions of caller  memset/25:
  Jump functions of caller  vApplicationMallocFailedHook/24:
  Jump functions of caller  xTaskResumeAll/23:
  Jump functions of caller  vTaskSuspendAll/22:
  Jump functions of caller  vPortHeapResetState/21:
  Jump functions of caller  vPortGetHeapStats/20:
    callsite  vPortGetHeapStats/20 -> vPortExitCritical/27 : 
       no arg info
    callsite  vPortGetHeapStats/20 -> vPortEnterCritical/26 : 
       no arg info
    callsite  vPortGetHeapStats/20 -> xTaskResumeAll/23 : 
       no arg info
    callsite  vPortGetHeapStats/20 -> vTaskSuspendAll/22 : 
       no arg info
  Jump functions of caller  prvInsertBlockIntoFreeList/19:
  Jump functions of caller  prvHeapInit/18:
  Jump functions of caller  pvPortCalloc/17:
    callsite  pvPortCalloc/17 -> memset/25 : 
       no arg info
    callsite  pvPortCalloc/17 -> pvPortMalloc/12 : 
       param 0: UNKNOWN
         value: 0x0, mask: 0xffffffff
         Unknown VR
  Jump functions of caller  vPortInitialiseBlocks/16:
  Jump functions of caller  xPortGetMinimumEverFreeHeapSize/15:
  Jump functions of caller  xPortGetFreeHeapSize/14:
  Jump functions of caller  vPortFree/13:
    callsite  vPortFree/13 -> xTaskResumeAll/23 : 
       no arg info
    callsite  vPortFree/13 -> prvInsertBlockIntoFreeList/19 : 
       param 0: PASS THROUGH: 0, op pointer_plus_expr 4294967288
         value: 0x0, mask: 0xffffffff
         VR  [1, -1]
    callsite  vPortFree/13 -> vTaskSuspendAll/22 : 
       no arg info
  Jump functions of caller  pvPortMalloc/12:
    callsite  pvPortMalloc/12 -> vApplicationMallocFailedHook/24 : 
       no arg info
    callsite  pvPortMalloc/12 -> xTaskResumeAll/23 : 
       no arg info
    callsite  pvPortMalloc/12 -> xTaskResumeAll/23 : 
       no arg info
    callsite  pvPortMalloc/12 -> xTaskResumeAll/23 : 
    ...
    callsite  pvPortMalloc/12 -> xTaskResumeAll/23 : 
       no arg info
    callsite  pvPortMalloc/12 -> prvHeapInit/18 : 
    callsite  pvPortMalloc/12 -> vTaskSuspendAll/22 : 
       no arg info

 Propagating constants:

Not considering vPortGetHeapStats/20 for cloning; -fipa-cp-clone disabled.
Not considering pvPortCalloc/17 for cloning; -fipa-cp-clone disabled.
Not considering vPortFree/13 for cloning; -fipa-cp-clone disabled.
Not considering pvPortMalloc/12 for cloning; -fipa-cp-clone disabled.
...
Lattices:
  ...
  Node: pvPortCalloc/17:
    ...
    param [1]: BOTTOM
         ...
         int VARYING
        AGGS BOTTOM
  Node: vPortInitialiseBlocks/16:
  Node: xPortGetMinimumEverFreeHeapSize/15:
  Node: xPortGetFreeHeapSize/14:
  Node: vPortFree/13:
    param [0]: BOTTOM
         ctxs: BOTTOM
         Bits unusable (BOTTOM)
...
;; Function pvPortMalloc (pvPortMalloc, funcdef_no=4, decl_uid=6096, cgraph_uid=5, symbol_order=12)

Modification phase of node pvPortMalloc/12
...
;; Function vPortFree (vPortFree, funcdef_no=5, decl_uid=6101, cgraph_uid=6, symbol_order=13)

Modification phase of node vPortFree/13
vPortFree (void * pv)
{
  uint8_t * puc;
  unsigned int _1;
...
;; Function xPortGetFreeHeapSize (xPortGetFreeHeapSize, funcdef_no=6, decl_uid=6105, cgraph_uid=7, symbol_order=14)

Modification phase of node xPortGetFreeHeapSize/14
...
;; Function xPortGetMinimumEverFreeHeapSize (xPortGetMinimumEverFreeHeapSize, funcdef_no=7, decl_uid=6107, cgraph_uid=8, symbol_order=15)

Modification phase of node xPortGetMinimumEverFreeHeapSize/15
...
;; Function vPortInitialiseBlocks (vPortInitialiseBlocks, funcdef_no=8, decl_uid=6103, cgraph_uid=9, symbol_order=16)

Modification phase of node vPortInitialiseBlocks/16
...
;; Function pvPortCalloc (pvPortCalloc, funcdef_no=9, decl_uid=6099, cgraph_uid=10, symbol_order=17)

Modification phase of node pvPortCalloc/17
...
;; Function vPortGetHeapStats (vPortGetHeapStats, funcdef_no=12, decl_uid=6094, cgraph_uid=13, symbol_order=20)
...
;; Function vPortHeapResetState (vPortHeapResetState, funcdef_no=13, decl_uid=6109, cgraph_uid=14, symbol_order=21)

Modification phase of node vPortHeapResetState/21
vPortHeapResetState ()
{
  <bb 2> [local count: 1073741824]:
  # DEBUG BEGIN_STMT
