Creating summary for vPortValidateInterruptPriority/22:


Creating summary for vPortEnableVFP/21:
Function is not versionable.
Creating summary for vPortSetupTimerInterrupt/20:


Creating summary for SysTick_Handler/19:


Creating summary for PendSV_Handler/18:
Function is not versionable.
Creating summary for vPortExitCritical/17:


Creating summary for vPortEnterCritical/16:


Creating summary for vPortEndScheduler/15:


Creating summary for xPortStartScheduler/14:


Creating summary for prvPortStartFirstTask/13:
Function is not versionable.
Creating summary for vPortSVCHandler/12:
Function is not versionable.
Creating summary for prvTaskExitError/10:


Creating summary for pxPortInitialiseStack/9:
  Descriptor for parameter 0 pxTopOfStackD.5900
    not a candidate for splitting
  Descriptor for parameter 1 pxCodeD.5901
    not a candidate for splitting
  Descriptor for parameter 2 pvParametersD.5902
    not a candidate for splitting
...
Summary for node vPortValidateInterruptPriority/22:
  No parameter information. 


Summary for node vPortEnableVFP/21:
  Function does not have any associated IPA-SRA summary

Summary for node vPortSetupTimerInterrupt/20:
  No parameter information. 


Summary for node SysTick_Handler/19:
  No parameter information. 

  Summary for edge SysTick_Handler/19->xTaskIncrementTick/25:

Summary for node PendSV_Handler/18:
  Function does not have any associated IPA-SRA summary

Summary for node vPortExitCritical/17:
  No parameter information. 


Summary for node vPortEnterCritical/16:
  No parameter information. 


Summary for node vPortEndScheduler/15:
  No parameter information. 


Summary for node xPortStartScheduler/14:
  Returns value
  No parameter information. 

  Summary for edge xPortStartScheduler/14->prvTaskExitError/10:
    return value ignored
  Summary for edge xPortStartScheduler/14->vTaskSwitchContext/24:
    return value ignored
  Summary for edge xPortStartScheduler/14->prvPortStartFirstTask/13:
    return value ignored
  Summary for edge xPortStartScheduler/14->vPortEnableVFP/21:
    return value ignored
  Summary for edge xPortStartScheduler/14->vPortSetupTimerInterrupt/20:
    return value ignored

Summary for node prvPortStartFirstTask/13:
  Function does not have any associated IPA-SRA summary

Summary for node vPortSVCHandler/12:
  Function does not have any associated IPA-SRA summary

Summary for node prvTaskExitError/10:
  No parameter information. 


Summary for node pxPortInitialiseStack/9:
  Returns value
...
Function pxPortInitialiseStack/9 disqualified because it cannot be made local.
Function prvTaskExitError/10 disqualified because it cannot be made local.
Function vPortSetupTimerInterrupt/20 disqualified because it cannot be made local.
Function xPortStartScheduler/14 disqualified because it cannot be made local.
Function vPortEndScheduler/15 disqualified because it cannot be made local.
Function vPortEnterCritical/16 disqualified because it cannot be made local.
Function vPortExitCritical/17 disqualified because it cannot be made local.
Function SysTick_Handler/19 disqualified because it cannot be made local.
Function vPortValidateInterruptPriority/22 disqualified because it cannot be made local.
