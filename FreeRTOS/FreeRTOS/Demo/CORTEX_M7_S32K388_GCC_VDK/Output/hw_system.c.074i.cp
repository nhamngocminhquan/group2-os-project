...
Jump functions:
  Jump functions of caller  SystemInit/1:
...
;; Function SystemInit (SystemInit, funcdef_no=1, decl_uid=5504, cgraph_uid=2, symbol_order=1)

Modification phase of node SystemInit/1
SystemInit ()
{
  uint32_t x;
